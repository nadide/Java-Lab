...
public class StringManips {
	public static void main(String[] args) {
		...
		// get the substring for middle three characters of phrase
		middle3 = phrase.substring(middleIndex - 1, middleIndex + 1);

		// replace blank characters with asterisk
		switchedPhrase = switchedPhrase.replace(' ', '*');

		System.out.println("Please enter the your city and state: ");
		city = scan.nextLine();
		state = scan.nextLine();
		...
		System.out.println("Middle charecters of original phrase: " + middle3);
